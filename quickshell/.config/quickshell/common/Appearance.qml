...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        // Base tones
        property color rpBase:      "#faf4ed"  // main background
        property color rpSurface:   "#fffaf3"  // overlay surface
        property color rpOverlay:   "#f2e9e1"  // elevated surface
        property color rpMuted:     "#9893a5"  // subtle text / disabled
        property color rpSubtle:    "#797593"  // secondary text
        property color rpText:      "#575279"  // primary text
        property color rpLove:      "#b4637a"  // red accent
        property color rpGold:      "#ea9d34"  // yellow accent
        property color rpRose:      "#d7827e"  // rose accent (main primary)
        property color rpPine:      "#286983"  // teal/pine accent
        property color rpFoam:      "#56949f"  // foam accent
        property color rpIris:      "#907aa9"  // iris/purple accent
        property color rpHighlight: "#dfdad9"  // subtle highlight
        property color rpHighlightMed: "#cecacd"
        property color rpHighlightHigh: "#bfbbc8"

        // M3 semantic mapping → Rosé Pine Dawn
        property color m3primary:                rpRose
        property color m3onPrimary:              rpBase
        property color m3primaryContainer:       "#f0d8d8"
        property color m3onPrimaryContainer:     "#6e3a3a"
        property color m3secondary:              rpIris
        property color m3onSecondary:            rpBase
        property color m3secondaryContainer:     "#e8e0f0"
        property color m3onSecondaryContainer:   "#3d2f5a"
        property color m3background:             rpBase
        property color m3onBackground:           rpText
        property color m3surface:                rpBase
        property color m3surfaceContainerLow:    rpOverlay
        property color m3surfaceContainer:       "#ede8e3"
        property color m3surfaceContainerHigh:   rpHighlight
        property color m3surfaceContainerHighest: rpHighlightMed
        property color m3onSurface:              rpText
        property color m3surfaceVariant:         rpHighlight
        property color m3onSurfaceVariant:       rpSubtle
        property color m3inverseSurface:         rpText
        property color m3inverseOnSurface:       rpBase
        property color m3outline:                rpMuted
        property color m3outlineVariant:         rpHighlightHigh
        property color m3shadow:                 "#cecacd"
    }
