...
function M.setup(ctx)
  ...
  bind("XF86MonBrightnessUp", exec("~/.config/hypr/scripts/backlight-notify mon_up"), { repeating = true })
  bind("XF86MonBrightnessDown", exec("~/.config/hypr/scripts/backlight-notify mon_down"), { repeating = true })
  bind("XF86KbdBrightnessUp", exec("~/.config/hypr/scripts/backlight-notify kbd_up"), { repeating = true })
  bind("XF86KbdBrightnessDown", exec("~/.config/hypr/scripts/backlight-notify kbd_down"), { repeating = true })
